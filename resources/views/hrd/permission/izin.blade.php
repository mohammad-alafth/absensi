        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Daftar pengajuan izin yang sudah disetujui PJ
                </p>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-3xl shadow p-5">
                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">
                                {{ \Carbon\Carbon::parse($permission->tanggal)->translatedFormat('d F Y') }}
                            </p>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ asset('storage/' . $permission->lampiran) }}"
                            target="_blank"
                            class="inline-flex items-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-xl transition">
                    ...
                    <div class="flex gap-3 mt-5">
                        ...
                        <!-- APPROVE -->
                        <form action="{{ route('hrd.izin.approve', $permission->id) }}"
                            method="POST"
                            class="flex-1">
                        ...
                        <!-- REJECT -->
                        <form action="{{ route('hrd.izin.reject', $permission->id) }}"
                            method="POST"
                            class="flex-1">
                ...
                <div class="bg-white rounded-3xl shadow p-10 text-center text-gray-500">
                    ...
                    Belum ada pengajuan izin untuk HRD
