            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-slate-100/70 border border-white p-5 sm:p-8 space-y-6">
                ...
                <div class="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-gray-100">
                    ...
                    <a href="{{ route('hrd.rekap') }}"
                        class="text-xs font-bold text-[#1E40AF] hover:underline">
                        ← Kembali
                    </a>
                ...
                <div class="mb-2">
                    ...
                    <input
                        ...
                        class="w-full md:w-80 rounded-xl border-gray-300 text-sm focus:ring-[#1E40AF] focus:border-[#1E40AF]">
                ...
                <div
                    ...
                    <div
                        class="employee-card p-4 bg-rose-50 border border-rose-100 rounded-2xl text-center shadow-sm cursor-pointer"
